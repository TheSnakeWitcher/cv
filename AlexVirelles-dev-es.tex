...
\resumeSubheading
    ...
    \resumeItemListStart
        \item Creando \href{https://vesting.cooltech.quest}{cooltech arranger}, una plataforma decentralizada de vesting para tokens erc20 
          con distribucion automatica que se integra a la blockchain(polygon) y maneja dinamicamente
          la creacion de recursos de aws(api gateway, lambda y event bridge)
        ...
        \item Desarrollo de REST APIs y servicios backend con python usando el framework fastapi  
          y protocol buffers para la comunicacion entre servicios via rpc(tambien experiencia
