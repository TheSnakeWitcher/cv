...
\resumeSubheading
    ...
    {Mid Software developer}{Julio 2025 -  Enero 2026}

    \resumeItemListStart
        \item Construyendo una \href{https://vesting.cooltech.quest}{plataforma de vesting decentralizada} para tokens erc20 con distribucion
          automatica que integra blockchain y la creacion dinamica de recursos en aws como api gateway,
          lambda y event bridge

        \item Construyendo REST APIs y servicios backend con python principalmente usando framework web
          fastapi y protocol buffers para la comunicacion entre servicios via rpc
    \resumeItemListEnd 

\resumeSubheading
    { {\href{https://portal.fusy.app}{\color{black}{Fusyona}} }}{}
    {Mid Blockchain developer}{Junio 2024 - Abril 2025}
    ...
    \resumeItemListStart
        ...
        \item Construyendo una \href{https://github.com/Fusyona/web3-core}{libreria} de typescript para hacer facil la creacion SDKs
          que se proveen al front-end para interactuar con el backend y contractos inteligentes

        \item Configurando un flujo de trabajo automatica en CI con github actions que detecta vulnerabilidades al crear PRs
...
\resumeItemListStart
    \vspace{0.8mm}
    \item Gestion y analiticas de datos con sql y python usando librarias como pandas, numpy,
      etc(tambien experiencia con alternativas mas modernas como polars) y su visualizacion
      para reportes(seaborn,react,svelte,streamlit) 

    \item Experiencia construyendo soluciones IoT con architecturas event-driven que interactuan
      con message brokers como rabbitmq y kafka
    ...
    \item Creando un \href{https://github.com/TheSnakeWitcher/mypeople-go}{addressbook} con CLI(usando cobra), viper(para configuracion)
      y sqlite como base de datos(usando sqlc)

    \item Simple \href{https://github.com/TheSnakeWitcher/arbitrageur-contract}{contracto de arbitraje} escrito en solidity usando la libreria
      Openzeppelin-v4 que solicita flashloans usando el protocolo AAVE y
      ejecuta trades(o swaps) entre uniswap-v3 y quickswap-v3

    \item Construyendo servicios para manejar contactos escrito en rust usando clap para la 
      CLI y sqlite como base de datos

    \item \href{https://github.com/TheSnakeWitcher/hardhat-inspect.git}{Plugin para el framework hardhat} usando typescript para de forma
      conveniente acceder a ciertos datos de un proyecto hardhat y
      hacer el proceso de desarrollo mas facil y fluido
\resumeItemListEnd
